...
enum class BooleanKey(
    ...
    OApsAIMIMLtraining(key = "key_enable_ML_training", false),
    OApsAIMIMLLearningRate(key = "key_enable_ML_LearningRate", false),
    OApsAIMIMLFCL(key = "key_enable_ML_FCL", false),
    OApsAIMIEnableBasal(key = "key_enable_basal", false),
    OApsAIMIEnableStepsFromWatch(key = "count_steps_watch", false),
    OApsAIMIpregnancy(key = "key_use_AimiPregnancy",false),
    OApsAIMInight(key = "OApsAIMI_Enable_night",false),
    OApsAIMIhoneymoon(key = "key_use_Aimi_honeymoon",false)
}