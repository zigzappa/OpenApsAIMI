...
enum class BooleanKey(
    ...
    WearWizardCob("wearwizard_cob", defaultValue = true, dependency = WearControl, hideParentScreenIfHidden = true),
    WearWizardIob("wearwizard_iob", defaultValue = true, dependency = WearControl, hideParentScreenIfHidden = true),
    WearCustomWatchfaceAuthorization("wear_custom_watchface_autorization", defaultValue = false),
    WearNotifyOnSmb("wear_notifySMB", defaultValue = true),
    OApsAIMIMLtraining("key_enable_ML_training", false),
    OApsAIMIMLLearningRate("key_enable_ML_LearningRate", false),
    OApsAIMIMLFCL("key_enable_ML_FCL", false),
