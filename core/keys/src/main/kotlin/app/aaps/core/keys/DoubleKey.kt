...
enum class DoubleKey(
    ...
    OApsAIMIBFFactor(R.string.key_oaps_aimi_BF_factor,50.0,1.0,150.0),
    OApsAIMIBFPrebolus(R.string.key_prebolus_BF_mode,2.0,0.1, 10.0),
    OApsAIMIBFPrebolus2(R.string.key_prebolus2_BF_mode,2.0,0.1, 10.0),
