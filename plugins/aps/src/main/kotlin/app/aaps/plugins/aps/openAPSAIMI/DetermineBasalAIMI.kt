...
class DetermineBasalaimiSMB @Inject constructor(
    ...
    fun determine_basal(
        ...
        var rate = when {
            ...
            honeymoon && delta in 1.0 .. 6.0 && bg in 99.0..161.0 -> calculateRate(profile_current_basal, profile_current_basal, delta.toDouble(), "AI Force basal because honeymoon and bg lesser than 160 and delta lesser than 6", currenttemp, rT)
