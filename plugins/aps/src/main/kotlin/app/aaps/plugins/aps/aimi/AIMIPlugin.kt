...
@OpenForTesting
@Singleton
open class AIMIPlugin @Inject constructor(
    ...
    open fun provideDetermineBasalAdapter(): DetermineBasalAdapter = DetermineBasalAdapterAIMIJS(ScriptReader(context), injector)
}