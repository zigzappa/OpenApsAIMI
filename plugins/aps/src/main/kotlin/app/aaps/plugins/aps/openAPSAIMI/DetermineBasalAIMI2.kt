...
class DetermineBasalaimiSMB2 @Inject constructor(
    ...
    fun determine_basal(
        ...
        var rate = when {
            ...
            bg > 120 && delta > 0 && smbToGive == 0.0f && honeymoon -> calculateRate(basal, profile_current_basal, 5.0, "AI Force basal because bg is greater than 165 and SMB = 0U.", currenttemp, rT)
            else -> null
        }
        rate?.let {
            rT.rate = it
