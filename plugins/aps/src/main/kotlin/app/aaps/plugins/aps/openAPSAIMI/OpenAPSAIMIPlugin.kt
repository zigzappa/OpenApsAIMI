...
open class OpenAPSAIMIPlugin  @Inject constructor(
    ...
    private fun calculateVariableIsf(timestamp: Long, bg: Double?): Pair<String, Double?> {
        ...
        if (bg != null) {
            tdd = when {
                ...
                glucoseInMgdl > 140 -> tdd * dynISFadjusthyper
    ...
    override fun invoke(initiator: String, tempBasalFallback: Boolean) {
        ...
        val isfLimitMin = if (profileFunction.getUnits() == GlucoseUnit.MMOL) mgdlToMmolL(HardLimits

                                                                                              .MIN_ISF) else HardLimits.MIN_ISF
        ...
        category.apply {
            ...
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                ...
                addPreference(preferenceManager.createPreferenceScreen(context).apply {
                    ...
                    addPreference(AdaptiveIntPreference(ctx = context, intKey = IntKey.OApsAIMImealinterval, dialogMessage

                    = R.string.oaps_aimi_meal_interval_summary, title = R.string.oaps_aimi_meal_interval_title))
                })
                addPreference(preferenceManager.createPreferenceScreen(context).apply {
                    key = "mode_Breakfast"
                    title = "Breaskfast Mode settings"
